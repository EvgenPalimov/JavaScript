...
function showCategory(category) {
    ...
    let newProductMarkup = "";
    categoryProducts.forEach(product => newProductMarkup += getProductMarkup(product));
    productsElem.insertAdjacentHTML("afterbegin", newProductMarkup);
}
